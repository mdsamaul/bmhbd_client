    ...
    <div className="p-5 pb-0">
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <fieldset>
          ...
          <label
            htmlFor="draft"
            className="peer-checked/draft:text-sky-500 pl-1 font-mono pr-[20%]"
          >
            Email
          </label>
          ...
          <label
            htmlFor="published"
            className="peer-checked/published:text-sky-500 pl-1 font-mono"
          >
            Phone
          </label>
          ...
          <div className="hidden peer-checked/draft:block pt-2">
            ...
            <div className="flex items-center gap-3 py-3">
              ...
              <input
                type="email"
                className="w-full appearance-none bg-transparent border-b  text-gray-700 mr-3 py-2 px-2 leading-tight focus:outline-none"
                placeholder="Email"
        ...
        <label className="flex items-center gap-3 my-3">
          ...
          <div className="relative w-full pr-3">
            <input
              type={`${eyePassOpen ? "text" : "password"}`}
              className="w-full appearance-none bg-transparent border-b  text-gray-700 mr-3 py-2 px-2 leading-tight focus:outline-none"
        ...
        <Button rounded={"rounded"} btnText={"Sign In"}>
