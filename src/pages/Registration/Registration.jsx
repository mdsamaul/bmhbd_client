    ...
    return (
        ...
        <div className='my-14 relative h-[100vh]'>
            <div className='fixed transition duration-500 bg-red-600  top-0 left-0   right-0'>
                <div className='flex mt-3 items-center w-full bg-red-600 text-base font-medium  py-2 text-white text-start gap-4 pl-1'>
                    <AiOutlineArrowLeft />
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className='fixed inset-x-0 bottom-0 bg-red-700 w-full h-14'>
